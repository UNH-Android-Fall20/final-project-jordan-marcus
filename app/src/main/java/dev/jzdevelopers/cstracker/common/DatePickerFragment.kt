...
/** Kotlin Class DatePickerFragment,
 *  Fragment used for picking a date from the calendar
 */
class DatePickerFragment : DialogFragment(), DatePickerDialog.OnDateSetListener {
    ...
    // Function That Shows Toast After Date is Set
    override fun onDateSet(view: DatePicker, year: Int, month: Int, day: Int) {
        ...
        activity.findViewById<TextView>(R.id.eventDatePicker).text = formatDate(year, month, day)
    }
